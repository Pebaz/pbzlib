...
# TODO(pebaz): Allow custom comparator function
# TODO(pebaz): Just store everything using a HeapPointer to facilitate this
# TODO(pebaz): Integrate well with Chemical iterators
