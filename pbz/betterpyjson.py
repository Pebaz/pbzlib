"""
Interacting with JSON from Python should be as natural as it is in JavaScript.

(JSON objects in Python should allow you to use the dot `.` operator to access
fields.)
"""
